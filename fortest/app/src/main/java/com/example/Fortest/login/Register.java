...
public class Register extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDBOpenHelper = new DBOpenHelper(this); //获取数据库操作类
    ...
    private void initView(){
         ...
         */
        mIvRegisteractivityBack.setOnClickListener( this);  //注册页面的返回按钮
        mIvRegisteractivityShowcode.setOnClickListener( this); //注册页面的显示验证码按钮
        mBtRegisteractivityRegister.setOnClickListener(this); //注册按钮
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_registeractivity_register:    //注册按钮
                ...
                String sex="女";
                String birth="2021/05/08";
                String city="上海";
                String describe="这是第一个用户";
                String userInputCode = mEtRegisteractivityPhonecodes.getText().toString().toLowerCase();
                User user=new User(username,password,sex,birth,city,describe);
                //注册验证
                if (!TextUtils.isEmpty(username) && !TextUtils.isEmpty(password) && !TextUtils.isEmpty(userInputCode) ) {
                    if (TextUtils.equals(userInputCode, generateRealCode)) { //不能phoneCode.equals(generateRealCode) 因为string里面不能判断null
                        //将用户名和密码加入到数据库中
                        mDBOpenHelper.add(username,password,sex,birth,city,describe);
